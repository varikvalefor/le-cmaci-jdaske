...
\section{la \F{girzu}}
ni'o ga jo la'oi .\B{G}.\ du la'o zoi.\ \F{map} \AgdaField{proj₁} \OpF \$ \F{girzu} \B g\ .zoi.\ gi ro da poi ke'a cmima la'oi .\B{G}.\ zo'u ga je cmima la'oi .\B{g}.\ fa lo te orsi be da gi lo ve .orsi be da cu co'e ja nilzilcmi lo'i ro cmima be la'oi .\B{G}.\ be'o poi ke'a du lo te .orsi be da
...
.i lo me'oi .multiset.\ cu smimlu lo liste  .i ku'i ro da poi ke'a me'oi .multiset.\ zo'u ro de poi ke'a .multiset.\ zo'u ga naje lo co'e ja se porsi cu vajni fi lo nu facki lo jei da dunli de gi ga jo da du de gi ro di zo'u di cmima da jo de
...
\begin{itemize}
	...
	\begin{itemize}
		\item ga je ro da zo'u da cmima la'o zoi.\ \AgdaField{Selcmima.liste} \OpF \$ \AgdaField{Jdanunza'omro.velski} \B a .zoi.\ jo cu jetnu je cu velski ko'a gi
...
% .i lakne  .i la .varik. cu cusku dei ca le nu vo'a na morji lo du'u ma kau krinu
...
setoidLijda = record {
  ...
  _≈_ = λ a b → Lijda.marde a ≡ Lijda.marde b
              ...
              × Setoid._≈_ SLC (Lijda.cevni a) (Lijda.cevni b);
  isEquivalence = {!!} }
  where
